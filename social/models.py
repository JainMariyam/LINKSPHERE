...
from django.db.models.signals import post_save# dec4  userinte object  create cheyyunna timeil userprofileil object create aavum( ie., nammal register cheyyumbol aa datas user modelil aarikum save cheyyunnathu at the same time userprofile modelil a user verum post_save means usermodelil save cheythu kazhiyumbol mathram )
from django.utils import timezone


# Create your models here. December 1
class UserProfile(models.Model):
    user=models.OneToOneField(User,on_delete=models.CASCADE,related_name="profile")
    address=models.CharField(max_length=200,null=True)#(null true koduthathu...line 54 il userinte instance mathree koduthittullu...so baaki fields ippo venda athu null aaki)
...
class Posts(models.Model):
    ...
    post_image=models.ImageField(upload_to="posters",null=True,blank=True)# null=true kodukkumbol databaseinu vendi,blank=true forminu vendi
