...
urlpatterns=[
    ...
    path('profiles/<int:pk>/follow',views.FollowView.as_view(),name='follow'),# ethu profileine aano follow ,unfollow cheyyendathu pullide id pass cheyyanam
...
]+ static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)# django static files
